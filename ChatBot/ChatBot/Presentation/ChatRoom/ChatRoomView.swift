...
final class ChatRoomView: UIView {
    ...
    private func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            collectionView.bottomAnchor.constraint(equalTo: chattingTextField.topAnchor, constant: defaultMargin),
            ...
            chattingTextField.bottomAnchor.constraint(equalTo: keyboardLayoutGuide.topAnchor, constant: -defaultMargin),
